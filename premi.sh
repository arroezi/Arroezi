...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To HV PROJECT SCRIPT ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}HV PROJECT® ${NC}${YELLOW}(${NC} ${green} HENDRA STORE ${NC}${YELLOW})${NC}"
echo -e " Recode By ARROEZI VPN STORE${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
url_izin="https://raw.githubusercontent.com/arroezi/Arroezi/main/izin"
...
REPO="https://raw.githubusercontent.com/arroezi/Arroezi/main/"
start=$(date +%s)
secs_to_human() {
...
TIMES="10"
CHATID="6610367720"
KEY="7996171158:AAFoji60m3VeyANju5-svSc5MbK3vk37EoU"
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/628"}]]}' 
...
7z x -p123Alaska@ m.zip >/dev/null 2>&1
chmod +x menu/*
